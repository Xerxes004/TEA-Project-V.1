...
public class Tools {
    ...
    public static void main (String[] args) {
        ...
        Integer[] testInt = {0xffff};

        System.out.println("Initial value 1: " + Integer.toHexString(testInt[0]));
        
        byte[] bytes = convertFromIntsToBytes(testInt);
        
        System.out.println("Converted to: " + Integer.toHexString(bytes[0]));
        
        testInt = convertFromBytesToInts(bytes);
        
        System.out.println("End value: " + Integer.toHexString(testInt[0]));
